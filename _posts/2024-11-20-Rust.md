---
title: Notes on Rust - my notes on learning Rust 
author_profile: true
categories: [dev]
tags: [Rust]
excerpt: "humble Rustbeginnings using TCM Security Rust 101 course" 
--- 
...
```bash
I started learning Rust this week through the TCM Security Rust 101 course so i decided to drop my notes here. Enjoy and drop me any feedback ! 
```  
...
- traits - a group of methods defined for a particular type - allows to write generic code allowing to work with wide range of types - agnostic code - re-usable code acorss different types
