...
Heath Adams version *(contains useless stuff bcz no check has been done without `[allow(unused)]` => practical to dev IMO but needs to be removed later on to clean the code.*  
