...
// found this function here: https://doc.rust-lang.org/rust-by-example/std_misc/file/read_lines.html
    ...
    if let Ok(password_list) = read_lines(password_file) {
        for password in password_list.flatten() {
            ...
            if (hex_result == *wanted_hash) {
                println!("hash: {} cracked into {:?}", wanted_hash, password);
            };

            println!("hashed: {:?}", hex_result);
        }
    }
