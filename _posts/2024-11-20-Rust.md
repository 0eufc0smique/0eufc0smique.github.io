...
```  
I added the possibility to pass a password list path as an argument and voila:  
...
type ResultFileLine = io::Result<io::Lines<io::BufReader<File>>> ;

fn read_lines<P>(filename: P) -> ResultFileLine
where P: AsRef<Path>,
{
