...
```bash
This are the notes i'm taking on mu journey to learn Rust. I started with `TCM Security Rust 101 course`, and in parallel used ZeroPointSecurity `Rust for n00bs` course.  
...
## Collections
### vectors  
sequence collection - single data type - variable length - slower than arrays but more flexible => resizable & dynamic
...
fn main() {
    ...
    // primites type i8 i16 i32 i64 u8 u16 u32 u64, float and chars have copy trait 
